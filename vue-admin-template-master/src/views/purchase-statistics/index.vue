      ...
      <el-form ref="form" :model="filterData" label-width="80px">
        ...
        <el-form-item label="销量区间">
          <el-radio-group v-model="filterData.sales">
            <el-radio :label="0">全部</el-radio>
            <el-radio :label="1">0-100</el-radio>
            <el-radio :label="2">100-300</el-radio>
            <el-radio :label="3">300-800</el-radio>
            <el-radio :label="4">800以上</el-radio>
          </el-radio-group>
        </el-form-item>
      </el-form>
    </div>
    <div>
      <bar-chart v-if="isShow" :x-axis-data="chartObj.bus_name" :series-data="chartObj.bus_sales" />
    </div>
  </div>
</template>
